...
**Note that the raw data need to be download previously for this effort script to work. Please run the "03-LoadManipSite.Rmd" to accses and save the raw data in th 'Data' folder. 
